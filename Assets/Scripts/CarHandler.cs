...
public class SimpleCarController : MonoBehaviour
{
    ...
    private MyPlayerController2 playerController;
    private void Start()
    {
        // Get the Rigidbody component
        rb = GetComponent<Rigidbody>();
        playerController = player.GetComponent<MyPlayerController2>();
    }

    private void Update()
    {
        bool isFollowingCar = playerController.isFollowingCar;
        if (isFollowingCar)
        {
            // Get player input
